...
# def graph_mixed_score_precise(mapEntity, generalData, mapName, maxK=1, maxL=4, maxB=1, reverse_task=True):
#     G = create_graph(mapEntity, generalData)
#     # Variables on solution and score
#     solution = {LK.locations: dict()}
#     total_score = {
...
#                         continue
#                     solution_tmp = {LK.locations: solution_tmp}
#                     temppp = {LK.locations: solution[LK.locations] | solution_tmp[LK.locations]}
#                     scoredSolution = calculateScore(mapName, temppp, mapEntity, generalData)
#                     for Skey in total_score:
#                         total_score[Skey] = scoredSolution[SK.gameScore][Skey]
#                     # footfall = total_score[SK.totalFootfall]
#                     #print(solution_tmp, total)
#                     total = total_score[SK.total]
#                     if total > best_total: #or (total == best_total and footfall > best_footfall):
#                         best_solution = solution_tmp
#                         best_total = total
#                         # best_footfall = total_score[SK.totalFootfall]
